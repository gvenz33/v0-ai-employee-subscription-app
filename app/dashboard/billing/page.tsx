...
import { createBillingPortalSession, cancelSubscription, getInvoices } from '@/app/actions/stripe'
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                {currentPlan?.priceInCents === 0 
                  ? 'Free forever' 
                  : `$${(currentPlan?.priceInCents || 0) / 100}/month`}
              </p>
            </div>
      ...
      <div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {SUBSCRIPTION_PLANS.map((plan) => {
            ...
            const isUpgrade = SUBSCRIPTION_PLANS.findIndex(p => p.id === plan.id) > 
                             SUBSCRIPTION_PLANS.findIndex(p => p.id === currentTier)
